...
News
======
**January 19, 2026**: NEW OPEN ACCESS PAPER! A paper I led on, "The Inclusion Trade-Off: Comparing the Design and Functionality of Collaborative Governance Forums" was published in [Policy Studies Journal](https://doi.org/10.1111/psj.70099). We explore how the level of inclusion in collaborative forums afffects their functionality, as assessed by forum participants. We compare four water user associations in Arizona through a survey and find that (i) more restrictive forums can benefit from high coordination that spills over to other capacities that require greater participant buy-in, such as lobbying and advocacy support, (ii) more inclusive forums can generate increased interactions among diverse users that spills over to broader regional cooperation, and (iii) management concerns of participants, especially their relative concern for groundwater vs. surface water availablity and financing infrastructure, can confound the effect of inclusion on perceived functionality. As modern policy challenges continue to cross existing jurisdictions, a challenging question facing policy actors is deciding who to include in necessary collaborative forums. Our comparative work provides new insight for addressing this question and speaks to the need for more comparative work in the study of polycentric governance, inclusion, and collaboration. See [Current Projects](/projects/) for more information on the project. 

**December 15-17, 2025**: I participated in the 2025 American Geophysical Union Meeting in New Orleans, LA. There, I convened two poster sessions on, "Advances in Modeling and Governing Interacting Shocks in the Anthropocene," as part of my role in the [Beijer Young Scholars](https://beijer.kva.se/current-beijer-young-scholars/) cohort, and "Preparing the Next Generation of Researchers to Meet Transdisciplinary Environmental Challenges" as part of my role in the Early Career Working Group of the [MultiSector Dynamics](https://multisectordynamics.org/) community. I also presented my work on, "Modeling Decision Making Under Uncertainty in Polycentric Sustainable Infrastructure Transitions" in a session dedicated to modeling human responses in MultiSector Dynamics research. It is always a privilege to engage with the MultiSector Dynamics and wider AGU Global Change community's enthusiasm for interdisciplinary scholarship, and I appreciated the opportunity to make new connections across infrastructure sectors and technical perspecitves.  

<img src="/images/AGU.jpg" alt="Photo from AGU" width="400"/>
...
<img src="/images/aspen_biggroup.JPG" alt="Photo from AGCI" width="400"/>
